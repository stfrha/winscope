// Declarations for FRHAWDM driver
...
#define DRIVERNAME "FRHAWDM"				// for use in messages
#define LDRIVERNAME L"FRHAWDM"				// for use in UNICODE string constants
...
typedef struct _DEVICE_EXTENSION {
	...
	USBD_PIPE_HANDLE OutBulk;
	USBD_PIPE_HANDLE INBulk;
