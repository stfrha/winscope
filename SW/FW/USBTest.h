...
#define CCLK                P1.3
#define RDY_BUSY_N          P1.4
#define PROGRAM_N           P1.5
#define INIT_N              P1.6
#define DONE                P1.7
#define DATA_BUS            P0                
 

/* FPGAConfiguration states */
#define FCS_IDLE            0x00
#define FCS_CONFIGURING     0x01
...
#define CPU_FW_VER_STR  "WinScope CPU FW Version 0.4"
